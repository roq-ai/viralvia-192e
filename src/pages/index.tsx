...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Viralvia`}</title>

        <meta
          name="description"
          content="Welcome to Viralvia - Your one-stop simplified SaaS platform for content creation. Get your business noticed with unique content created by individual creators in exchange for money or exclusive business perks."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1613633043968-e4ffc82d241b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb250ZW50JTIwY3JlYXRpb258ZW58MHx8fHwxNjk2NDQ4MDExfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@maltehelmhold?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Malte Helmhold`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Viralvia - Your one-stop simplified SaaS platform for content creation. Get your business noticed with unique content created by individual creators in exchange for money or exclusive business perks.`}
            </Text>
            <Box
