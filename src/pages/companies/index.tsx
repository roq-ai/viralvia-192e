...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'content.count', 'contract.count', 'discount_coupon.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('contract', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('discount_coupon', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'discount_coupon',
          header: 'Discount Coupon',
          accessorKey: 'discount_coupon',
          cell: ({ row: { original: record } }: any) => record?._count?.discount_coupon,
        }
      : null,
